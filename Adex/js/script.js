...
let lastActiveAccordian = accordian[0];
const initAccordian = (currentAccordian) => {
    const accordianBtn = currentAccordian.querySelector("[data-accordian]");
    const expandefAccordian = () => {
    ...
    accordianBtn.addEventListener("click", expandefAccordian);
};
